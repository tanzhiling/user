...
class IndexPage extends React.Component {
  ...
  onSort() {
    let that = this;
    that.setState({
      sortClick: !that.state.sortClick,
    });
    console.log(that.state.sortClick);
  }
  render() {
    return (
      <div>
        ...
        <div className={styles.main} id={'a'}>
          <div className={styles.nav}>
            ...
            <a
              href={'#a'}
              className={
                this.sortClick == false ? styles.sortFocus : styles.sort
              }
              onClick={() => this.onSort()}
            >
              <h4>综合排序</h4>
